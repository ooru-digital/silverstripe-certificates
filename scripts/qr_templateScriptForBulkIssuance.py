...
def process_svg_files_in_folder(folder_path, dry_run=True, config_file="../scripts/config.yaml"):
    ...
    if svg_path:
        ...
        headers_form = {
                ...
                'x-jwt-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7Il9pZCI6IjY0YjYyZTkxZmZkYTQzNDE4NjU1NmQ5NiJ9LCJmb3JtIjp7Il9pZCI6IjY0YjYyZTkwZmZkYTQzNDE4NjU1NmQ2MSJ9LCJpYXQiOjE3MjkyNTU3MjEsImV4cCI6MTcyOTI3MDEyMX0.PPY1G5NxDvpL9YkAs_r7vd39Fiubp9wZrAgD1K_bivA'
                }
        temp = None 
        subj = None
        if not dry_run:
...
if __name__ == "__main__":
        ...
        for folder in os.listdir(base_directory):
            ...
            if os.path.isdir(folder_path):
                ...
                count = count + 1
                if count%5 == 0:
                    print("Pause for 3 sec...")
                    time.sleep(3)


# For Dry Run : 
# python3 qr_templateScriptForBulkIssuance.py true


# For Actual API Call : 
# python3 qr_templateScriptForBulkIssuance.py false